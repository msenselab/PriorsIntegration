...
try
    ...
    [intervalSet1, deltaY] = generateRange(400, 800, 4); %0.4000    0.4757    0.5657    0.6727    0.8000
    intervalSet1 = intervalSet1/1000;

    [intervalSet2] = generateRangeDY(1200, deltaY, 4); %1.2000    1.4270    1.6971    2.0182    2.4000
